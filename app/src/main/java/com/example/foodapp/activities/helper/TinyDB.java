...
public class TinyDB {
    ...
    public ArrayList<FoodItem> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodItem> playerList =  new ArrayList<FoodItem>();

        for(String jObjString : objStrings){
            FoodItem player  = gson.fromJson(jObjString,  FoodItem.class);
    ...
    public void putListObject(String key, ArrayList<FoodItem> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodItem player: playerList){
